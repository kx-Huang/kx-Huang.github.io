...
tags: [shell, Linux, auto-completion, C] # TAG names should always be lowercase
mermaid: true
image:
...
This project is originated from a course project in `VE482 Operating System` [@UM-SJTU Joint Institute](https://www.ji.sjtu.edu.cn/){:target="\_blank"}. In this project, a mini shell called `mumsh` is implemented with `programming language C` for Unix-like machine.
