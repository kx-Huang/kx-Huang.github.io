---
title: "Mumsh: A Mini Shell Written in C"
date: 2022-02-16 00:23:18 -0600
categories: [archive, blogs]
tags: [shell, operating system, auto-completion, C] # TAG names should always be lowercase
image:
  src: /assets/img/blog/mumsh/mumsh_demo.png
...
This project is originated from a course project in `VE482 Operating System` [@UM-SJTU Joint Institute](https://www.ji.sjtu.edu.cn/){:target="\_blank"}. In this project, I implement a mini shell called `mumsh` with `programming language C` for Unix-like machine.

You can find the source code in my [Github repo](https://github.com/kx-Huang/mumsh){:target="\_blank"}.
