...
This project is originated from a course project in `VE482 Operating System` [@UM-SJTU Joint Institute](https://www.ji.sjtu.edu.cn/). In this project, I implement a mini shell called `mumsh` with `programming language C`.

You can find the source code in my [Github repo](https://github.com/kx-Huang/mumsh).
