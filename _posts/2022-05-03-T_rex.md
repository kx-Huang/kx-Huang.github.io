---
title: "Google Chrome T-rex Runner but an Embedded Version"
date: 2022-05-03 04:56:35 -0500
categories: [archive, blogs]
tags: [FreeRTOS, Embedded System, C] # TAG names should always be lowercase
image:
  src: /assets/img/blog/T-rex/T-rex_demo.png
  width: 450 # in pixels
  height: 550 # in pixels
  alt: Embedded T-Rex Runner
---

# Documentation ![](https://visitor-badge.glitch.me/badge?page_id=kx-Huang.Embedded-T-Rex-Runner&left_color=gray&right_color=blue)

This project is a course project in *CS/ECE353 Microprocessor Systems* [@University of Wisconsin-Madison](https://www.wisc.edu){:target="\_blank"}. In general, we implement an embedded version of Google Chrome's T-rex Runner with some more interesting features using `FreeRTOS`.

You can find the source code in my [Github repo](https://github.com/kx-Huang/Embedded-T-Rex-Runner){:target="\_blank"}.
