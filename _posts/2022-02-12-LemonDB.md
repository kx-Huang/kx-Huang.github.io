---
title: "LemonDB: An Multi-threading Database written in C++"
date: 2022-02-12 21:07:32 -0600
categories: [archive, blogs]
tags: [database, multi-thread, C++] # TAG names should always be lowercase
image:
  src: /assets/img/blog/LemonDB/database.png
  width: 700 # in pixels
  height: 400 # in pixels
  alt: database
---

# Documentation ![Build Status](https://focs.ji.sjtu.edu.cn:2222/api/badges/ve482-21/p2-group-06/status.svg?ref=refs/heads/multi_threads) ![](https://visitor-badge.glitch.me/badge?page_id=kx-Huang.LemonDB&left_color=gray&right_color=blue)

This project is a course project in *VE482 Operating System* [@UM-SJTU Joint Institute](https://www.ji.sjtu.edu.cn/){:target="\_blank"}. In general, we implement an in-memory database `LemonDB` using C++ featured multi-threading.

You can find the source code in my [Github repo](https://github.com/kx-Huang/LemonDB){:target="\_blank"}.
