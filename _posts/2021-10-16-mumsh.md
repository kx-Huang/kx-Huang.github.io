---
title: "A C-based Mini Shell: mumsh"
date: 2021-10-17 01:12:18 +0800
categories: [archive, blogs]
tags: [shell, operating system] # TAG names should always be lowercase
image:
...
1.  [What files are related to `mumsh`](#0-files-related-to-mumsh)
2.  [How to build and run `mumsh`](#1-build-and-run-mumsh)
3.  [How to play with `mumsh`](#2-play-with-mumsh)
4.  [How to implement `mumsh`](#3-implement-mumsh-step-by-step)
