...
Assume we've already parsed user input into command `cmd` (we will talk about how to do implement simple parser with `Finite State Machine`in [Section 3.5](#350-a-simple-test-for-brain-parsing-commands), we have
